  ...
  return (
    <main className="min-h-screen bg-slate-50 px-4 py-10 font-sans text-slate-900 sm:px-6 sm:py-16">
      <div className="mx-auto max-w-5xl">
        ...
        <button type="button" className="mt-6 w-full bg-[#ccff66] px-5 py-3 font-bold text-black hover:bg-[#b3e65c] sm:w-auto" onClick={openAddStudent}>+ Add student</button>
        {ui.isModalOpen && (
            ...
            <section className="w-full max-w-md bg-white p-7 shadow-2xl" role="dialog" aria-modal="true">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mt-7 flex justify-end gap-3">
                  ...
                  <button type="submit" className="bg-[#ccff66] px-5 py-3 font-bold text-black hover:bg-[#b3e65c]" disabled={ui.submitting}>{ui.submitting ? (form.editingId === null ? "Adding..." : "Updating...") : form.editingId === null ? "Add student" : "Update student"}</button>
                </div>
              </form>
            </section>
          </div>
